...
from fluxcli.services.logger.config import LoggerConfig
...
class LoggerService(BaseModel):
    ...
    def info(self, msg: str | Any) -> None:
        logger.info(self.__wrap_message(msg))

    def debug(self, msg: str | Any) -> None:
        logger.debug(self.__wrap_message(msg))

    def warning(self, msg: str | Any) -> None:
        logger.warning(self.__wrap_message(msg))

    def error(self, msg: str | Any) -> None:
        logger.error(self.__wrap_message(msg))

    def exception(self, msg: str | Any) -> None:
        logger.exception(self.__wrap_message(msg))

    def __wrap_message(self, msg: str | Any) -> str:
